        ...
        <div>
            ...
            <div className="cards">
                <div className="card">
                    ...
                    <p>Empower users to personalize layout and organization for a customized experience.</p>
                </div>
                <div className="card">
                    <img src={Icon2} alt="" />
                ...
                <div className="card">
                    ...
                    <p className="p3">Work together, assign tasks and share task lists.</p>
                </div>
                <div className="card">
                    <img src={Icon4} alt="" />
                    <h1>Integration with other apps</h1>
                    <p className="p4">Streamlined workflow and data transfer with other apps</p>
                </div>
                <div className="card">
                    <img src={Icon5} alt="" />
                    <h1>Drag-and-drop</h1>
                    <p className="p5">Rearrangement of tasks, projects, and todo-lists</p>
                </div>
                <div className="card">
                    <img src={Icon6} alt="" />
                    <h1>Track progress</h1>
                    <p className="p6">Monitor the  status and completion of tasks, set milestone, and track time.</p>
                </div>
            </div>
        </div>
    </Stylecontainer>
